...
import { DataTable, DataTablePropsCell } from "primereact/datatable"
...
const baseEmptyProduct: Product = {
	id: null,
	code: "",
	name: "",
	image: null,
...
class TableState {
	...
	product: Product = baseEmptyProduct
...
export default function ProductsDemo() {
	...
	useEffect(() => {
		// void ProductService.getProducts().then((data) => setProducts(data))
		void store.init()
	}, [])
