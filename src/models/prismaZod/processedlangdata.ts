...
import { Completerest_countries_api_data_names, relatedrest_countries_api_data_namesSchema } from "./index"
...
export const processedLangDataSchema = z.object({
  id: z.number().int(),
  common: z.string(),
  official: z.string(),
...
export interface CompleteProcessedLangData extends z.infer<typeof processedLangDataSchema> {
  rest_countries_api_data_names: Completerest_countries_api_data_names
}

/**
 * relatedProcessedLangDataSchema contains all relations on your model in addition to the scalars
 *
 * NOTE: Lazy required in case of potential circular dependencies within schema
 */
export const relatedProcessedLangDataSchema: z.ZodSchema<CompleteProcessedLangData> = z.lazy(() => processedLangDataSchema.extend({
